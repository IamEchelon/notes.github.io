...
var _user$project$Main$myStyle = function (color) {
...
var _user$project$Main$signal = _elm_lang$core$Native_Platform.outgoingPort(
	'signal',
	function (v) {
		return v;
	});
			...
			case 'Trigger':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							signal: A2(_elm_lang$core$Basics_ops['++'], 'Note Triggered: ', _p3.tone_val)
						}),
					_1: _user$project$Main$signal(_p3.tone_val)
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{signal: 'Note Released'}),
					_1: _user$project$Main$signal('')
				};
		}
	});
var _user$project$Main$Note = F4(
	function (a, b, c, d) {
		return {color: a, shape: b, value: c, tone_val: d};
	});
var _user$project$Main$noteDecoder = A5(
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {notes: a, alertMessage: b, signal: c};
	});
var _user$project$Main$Release = function (a) {
	return {ctor: 'Release', _0: a};
};
var _user$project$Main$Trigger = function (a) {
	return {ctor: 'Trigger', _0: a};
};
var _user$project$Main$viewNote = function (note) {
	return A2(
			...
			_1: {
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onMouseDown(
						_user$project$Main$Trigger(note)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onMouseUp(
							_user$project$Main$Release(note)),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Main$displayNotes = function (notes) {
	var noteList = A2(_elm_lang$core$List$map, _user$project$Main$viewNote, notes);
	return A2(
		_elm_lang$html$Html$ol,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('flexcontainer '),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$reversed(true),
				_1: {ctor: '[]'}
			}
		},
		noteList);
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Welcome to Notes'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Main$displayNotes(model.notes),
				_1: {
					ctor: '::',
...
var _user$project$Main$getNotes = function () {
	var notesUrl = 'https://api.myjson.com/bins/1aojyd';
	return A2(
		...
		A2(
			...
			notesUrl,
			_elm_lang$core$Json_Decode$list(_user$project$Main$noteDecoder)));
}();
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Main.Msg":{"args":[],"tags":{"GetNotes":["Result.Result Http.Error (List Main.Note)"],"Release":["Main.Note"],"Trigger":["Main.Note"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Main.Note":{"args":[],"type":"{ color : String, shape : String, value : Int, tone_val : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
